  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form method="POST" action="{{route('monitoring.user.update')}}">
          {{ csrf_field() }}
          {{ method_field('PATCH') }}
          <div class="box-body">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group col-md-12">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="username" name="username" placeholder="Username..." pattern="[a-zA-Z0-9._]+" value="{{$user->username}}" required>
                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                </div>
              </div>
              @endif
