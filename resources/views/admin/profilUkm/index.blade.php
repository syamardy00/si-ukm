            ...
            <div class="post">
              <div class="user-block">
                <span class="username" style="margin-left: 0px;">
                  <a href="{{route('adminBeritaUkm.show', $b->id)}}">{{$b->judul_berita}}</a>
                </span>
              ...
              <li class="pull-right">
                <a href="{{route('adminBeritaUkm.show', $b->id)}}" class="link-black text-sm"><i class="fa fa-eye margin-r-5"></i> Baca Berita
                  </a></li>
              </ul>
              <br>
            </div>
