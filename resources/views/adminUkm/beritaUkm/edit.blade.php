...
<!-- bootstrap wysihtml5 - text editor -->
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Edit Berita Ukm</li>
  </ol>
  </section>
  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <form method="POST" action="{{route('beritaUkm.update', $berita[0]['id'])}}" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{ method_field('PATCH') }}
            ...
            <div class="box-body">
              ...
              <div class="form-group col-md-9">
                <label for="username">Judul Berita</label>
                  <input type="text" class="form-control" id="judul_berita" name="judul_berita" placeholder="Judul Berita..." value="{{$berita[0]['judul_berita']}}" required>
              </div>
              @endif
              ...
              <div class="form-group col-md-3">
                ...
                <div class="input-group col-md-12" style="padding-top:5px; padding-left:10px; padding-right:5px;">
                  ...
                  @else
                    <label>
                      <input type="radio" name="sifat_berita" value="internal" class="flat-red">
                      Internal
                    </label>
                    &nbsp; &nbsp; &nbsp;
                    <label>
                      <input type="radio" name="sifat_berita" value="umum" class="flat-red" checked>
                      Umum
                    </label>
                  @endif
                </div>
              ...
              <div class="form-group col-md-12">
                <label for="isi_berita">Isi Berita</label>
                  <textarea name="isi_berita" id="editor1" placeholder="Isi Berita ..." required
                            style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$berita[0]['isi_berita']}}</textarea>
              </div>
