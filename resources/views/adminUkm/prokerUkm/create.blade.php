...
<!-- bootstrap datepicker -->
  ...
  <section class="content">
    <form method="POST" action="{{route('prokerUkm.store')}}" enctype="multipart/form-data">
      {{ csrf_field() }}
      <div class="row">
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Tambah Program Kerja Ukm</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              <div class="box-body">
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" id="tgl_kegiatan" name="tgl_kegiatan" placeholder="Tanggal Kegiatan..." value="{{old('tgl_lahir')}}" required>
                  </div>
                </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <div class="input-group col-md-12">
                    <textarea name="deskripsi" id="" placeholder="Sekilas Deskripsi Program Kerja ..." required
                              style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{old('deskripsi')}}</textarea>
                  </div>
                </div>
