...
<link rel="stylesheet" href="{{url('/assets/bower_components/select2/dist/css/select2.min.css')}}">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Edit Anggota Ukm</li>
  </ol>
  </section>

  <section class="content">
    @foreach($anggota as $a)
    <form method="POST" action="{{route('anggotaUkm.update', $a->id_anggota)}}" enctype="multipart/form-data">
      {{ csrf_field() }}
      {{ method_field('PATCH') }}
      <div class="row">
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Anggota Ukm</h3>
              <a href="{{route('anggotaUkm.cetak_pdf', $a->id_anggota)}}" class="btn btn-xs btn-primary pull-right">Simpan PDF &nbsp; <i class="fa fa-file-pdf-o"></i></a>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              <div class="box-body">
