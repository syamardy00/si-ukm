    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        <li class="dropdown user user-menu">
          ...
          @if($profil[0]['foto'])
            <img src="{{url($profil[0]['foto'])}}" class="user-image" alt="User Image">
          @else
            <img src="{{url('/foto/default-image.png')}}" class="user-image" alt="User Image">
          @endif
            <span class="hidden-xs">{{$profil[0]['nama']}}</span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
            @if($profil[0]['foto'])
              <img src="{{url($profil[0]['foto'])}}" class="img-circle" alt="User Image">
            @else
            ...
            <li class="user-footer">
              ...
              <div class="pull-right">
                <a href="{{route('anggotaUkm.profilUser.index')}}" class="btn btn-default btn-flat">Profil Saya</a>
              </div>
            </li>
          </ul>
        </li>
